...
openssl req -x509 -newkey rsa:2048 -keyout client_private_key.pem -out client.pem -days 355 -nodes -addext "subjectAltName = URI:urn:example.org:FreeOpcUa:python-opcua"
