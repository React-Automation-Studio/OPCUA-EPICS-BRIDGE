...
openssl req -x509 -newkey rsa:2048 -keyout server_private_key.pem -out server.pem -days 355 -nodes -addext "subjectAltName = URI:urn:example.org:FreeOpcUa:python-opcua"
